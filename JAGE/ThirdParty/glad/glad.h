/*
    OpenGL loader generated by glad 0.1.36 on Fri Jan 17 23:53:37 2025.
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c" --spec="gl" --extensions="GL_ARB_base_instance,GL_ARB_bindless_texture"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.6&extensions=GL_ARB_base_instance&extensions=GL_ARB_bindless_texture
*/

#ifndef __glad_h_
#define __glad_h_

// Ensure that no previous OpenGL headers have been included.
#ifdef __gl_h_
#error OpenGL header already included, remove this include; glad already provides it.
#endif
#define __gl_h_

// Define APIENTRY macros if not already defined.
...
// Structure holding the loaded OpenGL version.
struct gladGLversionStruct {
    int major;
    int minor;
};

// Function pointer type for loading symbols.
typedef void* (*GLADloadproc)(const char *name);

// -----------------------------------------------------------------------
// Macro to define GLAPI based on export settings.
#ifndef GLAPI
...
// Global OpenGL version info and loader functions.
 ...
 *                           Macro Definitions
 * =======================================================================
 * (All GL defines are grouped here for consistency; see the original output
 * for the full list of definitions.)
 */

// Example definitions (the complete list remains as generated):
...
// ... (continue with all other GL_ defines)

// =======================================================================
//                  OpenGL Version Function Prototypes
// =======================================================================
...
// ... (additional function prototypes for GL_VERSION_1_0)
#endif
...
// ... (additional function prototypes for GL_VERSION_1_1)
#endif

// Continue grouping similar blocks for GL_VERSION_1_2, 1_3, 1_4, 1_5, 2_0, 2_1, 3_0, 3_1, 3_2, 3_3, 4_0, 4_1, 4_2, 4_3, 4_4, 4_5, and 4_6.
